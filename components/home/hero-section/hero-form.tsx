  ...
  return (
    <Form {...form}>
      <form
        ...
        className="lg:-mr-32 px-8 py-5 rounded bg-white flex md:flex-row flex-col items-end gap-3"
      >
        <div className="gap-4 w-full text-black flex md:flex-row flex-col items-center">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  ...
                  >
                    <SelectTrigger className=" text-gray-400 text-sm rounded border border-gray-200">
        ...
        <Button
          type="submit"
          className="bg-secondary  bottom-8 hover:bg-hover transition-all  text-white p-4 cursor-pointer rounded"
        >
          Go
        </Button>
      </form>
